...
With encryption, you take the data you’re trying to encrypt (plaintext), and you use the encryption algorithm (cipher) to encrypt the data and scramble it into a form (ciphertext) that is only readable by the private key.
