...
- Javascript disabled on Tor
  (This is mainly for people who are connecting to .onion sites, but it can be good advice for the clearnet too as he probably was using the clearnet)
